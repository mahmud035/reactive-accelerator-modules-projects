...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="{@TODO:Video Link}" target="_blank" >REACTIVE ACCELERATOR - MODULE 5 - LESSON {@TODO:LESSON_NO})</a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch {@TODO:BRANCH_NUMBER}
   ```sh
